...
public class resultsPreferentialFormController extends Controller{
    ...
    public void updateColumns(SessioneDiVoto s){
		...
		ArrayList<Candidato> results = (ArrayList<Candidato>) sessioneDAO.getResults(this.sessionId);
