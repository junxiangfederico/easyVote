...
public class votePreferentialform extends Application {
	 @Override
	    public void start(Stage primaryStage) {
	        try {
	            //Pane addPane = (Pane)FXMLLoader.load(getClass().getClassLoader().getResource("easyVoteproject/views/voteOrdinaryform.fxml"));
	        	Pane addPane = (Pane)FXMLLoader.load(getClass().getClassLoader().getResource("views/votePreferentialform.fxml"));
